...
public enum ErrorCode {
    ...
    INVALID_USER_NOT_EXISTED(1001, Collections.singletonList("User not exists!")),
    ...
    INVALID_LOGIN_FAILED(1002, Collections.singletonList("Username or Password invalid!"));
